...
var events = {
 ...
 /*
     ...
     */
	 sinhvien: {
        init: function(){
            events.sinhvien.search();
			events.sinhvien.update();
			events.sinhvien.add();
            events.sinhvien.delete();
        },
        reInit: function(){
            events.sinhvien.delete();
        },
        get: function(pageNumber){
            ...
            var name    = $("#form-search-sinhvien input[name='name']").val();
			var ngaysinh = $("#form-search-sinhvien input[name='ngaysinh']").val();
			var diachi   = $("#form-search-sinhvien input[name='diachi']").val();

           ajax.send("Sinhvien/getSinhvien", {name: name,ngaysinh: ngaysinh,diachi: diachi, page: pageNumber},
                events.sinhvien.get_search_callback, "#list-sinhvien");	
        },
        search: function(){
            $("#form-search-sinhvien").submit(function(e){
                e.preventDefault();
                ajax.send("Sinhvien/getSinhvien", helpers.serialize(this, "page=1"), events.sinhvien.get_search_callback, "#list-sinhvien");
            });
        },
        get_search_callback: function(result){
            if(helpers.validateData(result, "#form-search-sinhvien", "after", "default", "data")){
                $("#list-sinhvien tbody").html(result.data.sinhvien);
                events.sinhvien.reInit();
		 ...
		 update: function(){
            $("#form-update-sinhvien").submit(function(e){
                e.preventDefault();
                ajax.send("Sinhvien/updateSinhvien", helpers.serialize(this, "user_id="+config.sinhvienId), updateUserInfoCallBack, "#form-update-sinhvien");
            });
            function updateUserInfoCallBack(result){
                if(helpers.validateData(result, "#form-update-sinhvien", "after", "default", "success")){
                    $("#form-update-sinhvien").after(result.success);
                }
            }
        },
		add: function(){
			$("#create").submit(function(){
				ajax.send("Sinhvien/createSinhvien", helpers.serialize(this), createSinhvienCallBack, "#create");
			});
			function createSinhvienCallBack(result){
				if(helpers.validateData(result, "#create", "after", "default", "success")){
					alert(result.success + " refresh the page to see the results");
				}
			}
		},
        delete: function(){
            $("#list-sinhvien tr td .delete").click(function(e){
                e.preventDefault();
                if (!confirm("Are you sure?")) { return; }

                var row     = $(this).parent().parent().parent();
                var userId  = row.attr("id");
                ajax.send("Sinhvien/deleteSinhvien", {sinhvien_id: userId}, deleteUserCallBack);
                function deleteUserCallBack(result){
                    if(helpers.validateData(result, row, "after", "row", "success")){
                        $(row).remove();
                    }
	...
	giaovien: {
        init: function(){
            events.giaovien.search();
			events.giaovien.update();
			events.giaovien.add();
            events.giaovien.delete();
        },
        reInit: function(){
            events.giaovien.delete();
        },
        get: function(pageNumber){
            ...
            var name    = $("#form-search-giaovien input[name='name']").val();
			var ngaysinh = $("#form-search-giaovien input[name='ngaysinh']").val();
			var diachi   = $("#form-search-giaovien input[name='diachi']").val();

           ajax.send("Giaovien/getGiaovien", {name: name,ngaysinh: ngaysinh,diachi: diachi, page: pageNumber},
                events.giaovien.get_search_callback, "#list-giaovien");	
        },
        search: function(){
            $("#form-search-giaovien").submit(function(e){
                e.preventDefault();
                ajax.send("Giaovien/getGiaovien", helpers.serialize(this, "page=1"), events.giaovien.get_search_callback, "#list-giaovien");
            });
        },
        get_search_callback: function(result){
            if(helpers.validateData(result, "#form-search-giaovien", "after", "default", "data")){
                $("#list-giaovien tbody").html(result.data.giaovien);
                events.giaovien.reInit();
		 ...
		 update: function(){
            $("#form-update-giaovien").submit(function(e){
                e.preventDefault();
                ajax.send("Giaovien/updateGiaovien", helpers.serialize(this, "user_id="+config.giaovienId), updateUserInfoCallBack, "#form-update-giaovien");
            });
            function updateUserInfoCallBack(result){
                if(helpers.validateData(result, "#form-update-giaovien", "after", "default", "success")){
                    $("#form-update-giaovien").after(result.success);
                }
            }
        },
		add: function(){
			$("#create-giaovien").submit(function(){
				ajax.send("Giaovien/createGiaovien", helpers.serialize(this), createGiaovienCallBack, "#create-giaovien");
			});
			function createGiaovienCallBack(result){
				if(helpers.validateData(result, "#create-giaovien", "after", "default", "success")){
					alert(result.success + " refresh the page to see the results");
				}
			}
		},
        delete: function(){
            $("#list-giaovien tr td .delete").click(function(e){
                e.preventDefault();
                if (!confirm("Are you sure?")) { return; }

                var row     = $(this).parent().parent().parent();
                var userId  = row.attr("id");
                ajax.send("Giaovien/deleteGiaovien", {giaovien_id: userId}, deleteUserCallBack);
                function deleteUserCallBack(result){
                    if(helpers.validateData(result, row, "after", "row", "success")){
                        $(row).remove();
                    }
	...
	lop: {
        ...
        get: function(pageNumber){
            ...
            var name    = $("#form-search-lop input[name='name']").val();
			var giaovien = $("#form-search-lop input[name='giaovien']").val();
			var sinhvien = $("#form-search-lop input[name='sinhvien']").val();
           ajax.send("Lop/getLop", {name: name,giaovien: giaovien,sinhvien:sinhvien, page: pageNumber},
                events.lop.get_search_callback, "#list-lop");	
        },
        search: function(){
            $("#form-search-lop").submit(function(e){
                e.preventDefault();
                ajax.send("Lop/getLop", helpers.serialize(this, "page=1"), events.lop.get_search_callback, "#list-lop");
            });
        },
        get_search_callback: function(result){
            if(helpers.validateData(result, "#form-search-lop", "after", "default", "data")){
                $("#list-lop tbody").html(result.data.giaovien);
                events.lop.reInit();
		 ...
		 update: function(){
            $("#form-update-lop").submit(function(e){
                e.preventDefault();
                ajax.send("Lop/updateLop", helpers.serialize(this, "user_id="+config.lopId), updateUserInfoCallBack, "#form-update-lop");
            });
            function updateUserInfoCallBack(result){
                if(helpers.validateData(result, "#form-update-lop", "after", "default", "success")){
                    $("#form-update-lop").after(result.success);
                }
            }
        },
		add: function(){
            $("#form-add-sinhvien").submit(function(e){
                e.preventDefault();
                ajax.send("Lop/addSV", helpers.serialize(this, "user_id="+config.lopId), updateUserInfoCallBack, "#form-add-sinhvien");
            });
            function updateUserInfoCallBack(result){
                if(helpers.validateData(result, "#form-add-sinhvien", "after", "default", "success")){
                    $("#form-add-sinhvien").after(result.success);
                }
            }
        },
		addSV: function(){
			$("#create-lop").submit(function(){
				ajax.send("Lop/createLop", helpers.serialize(this), createGiaovienCallBack, "#create-lop");
			});
			function createGiaovienCallBack(result){
				if(helpers.validateData(result, "#create-lop", "after", "default", "success")){
					alert(result.success + " refresh the page to see the results");
				}
			}
		},
		xoa: function(){
            $("#form-xoa-sinhvien").submit(function(e){
                e.preventDefault();
                ajax.send("Lop/xoaSV", helpers.serialize(this, "user_id="+config.sinhvienId), updateUserInfoCallBack, "#form-xoa-sinhvien");
            });
            function updateUserInfoCallBack(result){
                if(helpers.validateData(result, "#form-xoa-sinhvien", "after", "default", "success")){
                    $("#form-xoa-sinhvien").after(result.success);
					$("#form-xoa-sinhvien").load('#form-xoa-sinhvien .form-group');
                }
            }
        },
        delete: function(){
            $("#list-lop tr td .delete").click(function(e){
                e.preventDefault();
                if (!confirm("Are you sure?")) { return; }

                var row     = $(this).parent().parent().parent();
                var userId  = row.attr("id");
                ajax.send("Lop/deleteLop", {lop_id: userId}, deleteUserCallBack);
                function deleteUserCallBack(result){
                    if(helpers.validateData(result, row, "after", "row", "success")){
                        $(row).remove();
                    }
