            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li id="sinhvien">
                            <a href="<?= PUBLIC_ROOT . "Sinhvien"; ?>"><i class="fa fa-users fa-fw"></i> Quản Lý Sinh Viên</a>
                        </li>
						<li id="giaovien">
                            <a href="<?= PUBLIC_ROOT . "Giaovien"; ?>"><i class="fa fa-users fa-fw"></i> Quản Lý Giáo Viên</a>
                        </li>
						<li id="lop">
                            <a href="<?= PUBLIC_ROOT . "Lop"; ?>"><i class="fa fa-users fa-fw"></i> Quản Lý Lớp</a>
                        </li>
